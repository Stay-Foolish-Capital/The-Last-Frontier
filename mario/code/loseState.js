...
Mario.LoseState.prototype.Update = function(delta) {
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) || IsButtonPressed('SButton')) {
...
Mario.LoseState.prototype.CheckForChange = function(context) {
    if (this.wasKeyDown && !(Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) || IsButtonPressed('SButton'))) {
